...
public class OrdersR {
    ...
    public OrdersR(int o_orderkey, int o_custkey, String o_orderstatus, String o_orderdate, String o_orderpriority, String o_clerk, String o_shippriority, String o_totalprice, String o_comment) {
